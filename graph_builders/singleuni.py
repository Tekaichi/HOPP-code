...
class SingleGraph(BaseGraph):
    ...
    def add_patient(x,patient,i,instance= None,lookup=None,masking_probability=0.0,bidirectional = False,**kwargs):
        ...
        for visit in patient:
            ...
            #for each diagnoses in visit..
            #for each modality.. list of dicts with suffix to use?
            ...
            for code in visit:
                ...
                instance.add_edge(visit_name,code)

            v = v + 1
        
        
        #TODO? For active learning? Add 'extra future' visit
